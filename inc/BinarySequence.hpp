...
namespace std {
template<>
class hash<receptor_detector::BinarySequence<uint64_t> > {
public:
    size_t operator()(const receptor_detector::BinarySequence<uint64_t>& s) const {
...
template<>
class hash<receptor_detector::BinarySequence<int64_t> > {
public:
    size_t operator()(const receptor_detector::BinarySequence<int64_t>& s) const {
        return MurmurHash64A(s.sequence.data(), int(s.get_byte_length()), 14741);
    }
};
...
template<>
class hash<receptor_detector::BinarySequence<uint32_t> > {
public:
    size_t operator()(const receptor_detector::BinarySequence<uint32_t>& s) const {
        return MurmurHash64A(s.sequence.data(), int(s.get_byte_length()), 14741);
    }
};
...
template<>
class hash<receptor_detector::BinarySequence<int32_t> > {
public:
    size_t operator()(const receptor_detector::BinarySequence<int32_t>& s) const {
        return MurmurHash64A(s.sequence.data(), int(s.get_byte_length()), 14741);
    }
};
...
template<>
class hash<receptor_detector::BinarySequence<uint16_t> > {
public:
    size_t operator()(const receptor_detector::BinarySequence<uint16_t>& s) const {
        return MurmurHash64A(s.sequence.data(), int(s.get_byte_length()), 14741);
    }
};
...
template<>
class hash<receptor_detector::BinarySequence<int16_t> > {
public:
    size_t operator()(const receptor_detector::BinarySequence<int16_t>& s) const {
        return MurmurHash64A(s.sequence.data(), int(s.get_byte_length()), 14741);
    }
};
...
template<>
class hash<receptor_detector::BinarySequence<uint8_t> > {
public:
    size_t operator()(const receptor_detector::BinarySequence<uint8_t>& s) const {
        return MurmurHash64A(s.sequence.data(), int(s.get_byte_length()), 14741);
    }
};
...
template<>
class hash<receptor_detector::BinarySequence<int8_t> > {
public:
    size_t operator()(const receptor_detector::BinarySequence<int8_t>& s) const {
        return MurmurHash64A(s.sequence.data(), int(s.get_byte_length()), 14741);
    }
};
...
template<>
class hash<receptor_detector::BinarySequence<__uint128_t> > {
public:
    size_t operator()(const receptor_detector::BinarySequence<__uint128_t>& s) const {
        return MurmurHash64A(s.sequence.data(), int(s.get_byte_length()), 14741);
    }
};
...
template<>
class hash<receptor_detector::BinarySequence<__int128_t> > {
public:
    size_t operator()(const receptor_detector::BinarySequence<__int128_t>& s) const {
        return MurmurHash64A(s.sequence.data(), int(s.get_byte_length()), 14741);
    }
};
